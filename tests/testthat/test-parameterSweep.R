...
# Test a large number of parameter combinations on an empty database just to make sure we dont'
# have simple errors in our code.

testAllParams <- function(connectionDetails, cdmDatabaseSchema, cdmVersion, oracleTempSchema = NULL) {
