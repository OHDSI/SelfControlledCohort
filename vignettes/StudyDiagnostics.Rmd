...
Five diagnostics are available. The first four are computed before estimation; EASE is computed during calibration when negative controls are provided.
...
Unlike the other four diagnostics, EASE requires **negative controls** and is computed **during calibration** rather than before estimation. If no `negativeControlPairs` are provided, the EASE diagnostic is simply skipped.
