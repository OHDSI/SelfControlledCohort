...
The calculation uses the **Musonda (2006) Signed Root Likelihood (SRL1)** method, which is specifically designed for self-controlled designs. It finds the rate ratio $RR$ satisfying the target power (80%) given the observed person-time and event counts in exposed and unexposed windows.
